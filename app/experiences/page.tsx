                ...
                <div className="flex flex-col gap-2">
                  <article className="prose text-justify">
                    <ul className="list-disc">
                      <li className="my-2">
                        <p>
                          Creating & developing a booking class website using
                          the Codeigniter 3.
                        </p>
                      </li>
                      <li className="my-2">
                        <p>
                          Developing & add features on the golden english portal
                          website using codeigniter also integrated with third
                          party websites as the whatsapp api service.
                        </p>
                      </li>
                      <li className="my-2">
                        <p>
                          Designing & developing golden english website, teacher
                          & student mobile app using Laravel & Flutter
                          integrated with Santry for website monitoring.
                        </p>
                      </li>
                      <li className="my-2">
                        <p>
